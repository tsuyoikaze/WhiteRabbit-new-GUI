...
public class LabeledRectangle implements MappingComponent {
	...
	public LabeledRectangle(int x, int y, int width, int height, MappableItem item) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;		
		this.item = item;
//		this.baseColor = aliceblue;
//		this.transparentColor = new Color(aliceblue.getRed(), aliceblue.getGreen(), aliceblue.getBlue(), 128);
	}
